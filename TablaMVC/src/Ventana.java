...
public class Ventana extends JFrame {
    ...
    public Ventana(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(148, 168, 248));
        lblId = new JLabel("Id: ");
        ...
        lblDesarrollador = new JLabel("Deasrrollador: ");
        ...
        panel2.setBackground(new Color(178, 253, 141));
        info = new ArrayList<>();
        info.add(new VideoJuego(1,"League of Legendes","MOBA",4.5,"Windows y Mac", "RIOT Games"));
